...
const Footer = memo(
  ({
    ...
    const handleSubmit = async (e) => {
      ...
      setIsLoading(true);
      try {
        const response = await fetch("http://localhost:5055/api/settler/", {
          method: "POST",
          headers: {
        ...
        >
          <div className="w-full flex flex-row items-start justify-center gap-10 mq480:flex-col">
            ...
            <div className="flex flex-col items-start justify-start gap-6">
              ...
              <form onSubmit={handleSubmit} className="self-stretch flex flex-col items-start justify-start gap-4 w-full">
                ...
                >
                  <div className="relative leading-[150%] font-medium">Join</div>
                </button>
              </form>

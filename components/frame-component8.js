...
const FrameComponent8 = memo(({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[26px] box-border max-w-full text-left text-21xl text-background-color-primary font-h4-32 ${className}`}
    >
      <div className="flex-1 overflow-hidden flex flex-row items-start justify-start py-[60px] px-20 box-border bg-[url('/stores@3x.png')] bg-cover bg-no-repeat bg-[top] max-w-full mq750:py-[39px] mq750:px-10 mq750:box-border">

...
const EyeGlassesMblMenu = memo(({ className = "", category }) => {
  const router = useRouter();
  const handleNavigation = () => {
    const eyeglassesCategory = category.find(
      ...
      <section className="self-stretch flex flex-col items-start justify-start gap-2 text-center text-sm text-black font-h4-32">
        <div className="self-stretch flex flex-col items-start justify-start">
          ...
          <div className="self-stretch flex flex-row items-center justify-start py-1.5 px-0">
            <div
              className="relative leading-[150%] text-xs uppercase cursor-pointer"
              onClick={() => handleNavigationGender("Men", category?.[4]?.slug)}
            >
              For Men
            </div>
          </div>
          <div className="self-stretch flex flex-row items-center justify-start py-1.5 px-0">
            <div
              className="relative leading-[150%] text-xs uppercase cursor-pointer"
              onClick={() =>
                handleNavigationGender("Women", category?.[4]?.slug)
              }
            >
              For Women
            </div>
          ...
          <div className="self-stretch flex flex-row items-center justify-start py-1.5 px-0">
            <div
              className="relative leading-[150%] text-xs uppercase cursor-pointer"
              onClick={() =>
                handleNavigationGender("Kids", category?.[4]?.slug)
              }
            >
              For Kids
            </div>
...
EyeGlassesMblMenu.propTypes = {
  className: PropTypes.string,
};

export default EyeGlassesMblMenu;
